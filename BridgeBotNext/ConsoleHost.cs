...
namespace BridgeBotNext
{
    public static class ConsoleHost
    {
        ...
        {
            if (!string.IsNullOrEmpty(shutdownMessage)) Console.WriteLine(shutdownMessage);
            ...
            string shutdownMessage)
        {
            Action ShutDown = () =>
            {
                ...
                {
                    if (!string.IsNullOrWhiteSpace(shutdownMessage)) Console.WriteLine(shutdownMessage);
                    try
                    {
                        cts.Cancel();
                    }
